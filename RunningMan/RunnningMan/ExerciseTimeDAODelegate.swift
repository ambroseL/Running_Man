...
import Foundation
@objc
public protocol ExerciseTimeDAODelegate {
    ...
    //按照主键查询数据方法 成功
    @objc optional func findByIdFinished(_ model: ExerciseTimeInfo)
    ...
    //验证Note方法 成功
    @objc optional func checkFinished()
    
    //验证Note方法 失败
    @objc optional func checkFailed(_ error: NSError)
