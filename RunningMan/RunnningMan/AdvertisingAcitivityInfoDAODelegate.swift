//
//  AdvertisingAcitivityInfoDAODelegate.swift
//  RunningMan
//
...
import Foundation
@objc
public protocol AdvertisingActivityInfoDAODelegate {
    ...
    //按照主键查询数据方法 成功
    @objc optional func findByIdFinished(_ model: AdvertisingActivityInfo)
